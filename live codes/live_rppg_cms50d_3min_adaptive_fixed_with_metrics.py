...
CMS50D_PORT = "COM5" \
""          # Change to your active CMS50D port
...
def run_live_acquisition():
    ...
    try:
        while time.time() - start_time < DURATION_SECONDS:
            ...
            # If the subject is moving/repositioning, do not update HR from corrupted frames.
            ...
            if SHOW_PREVIEW_WINDOW:
                ...
                cv2.putText(
                    display_frame,
                    f"Frame {frame_count} | Time {elapsed_total:.1f}/{DURATION_SECONDS:.1f}s | Motion: {live_motion_class} | Pos {position_segment_id}: {position_state}",
                    (10, 30),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    0.58,
                    (255, 255, 255),
